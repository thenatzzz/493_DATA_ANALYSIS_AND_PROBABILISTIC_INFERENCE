...
#    noStates = [int(x) for x in f.readline().split()]
    ...
    #    data_point  = [int(u) for u in f.readline().split()]
    #    somedata.append(data_point)
       datain.append(map(int,((f.readline()).split())))
    f.close()
    #return [noVariables, noRoots, noStates, noDataPoints, somedata]
